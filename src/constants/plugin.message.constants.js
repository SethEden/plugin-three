...
export const cPluginThreeMessage01 = wrd.cThis + bas.cSpace + bas.cis + bas.cSpace + bas.ca + bas.cSpace + wrd.cmessage + bas.cSpace + wrd.cfrom + bas.cSpace + wrd.cPlugin + num.cThree + bas.cDot; // This is a message from PluginThree.
